...
const [listProjects] = useState([
  {
    ...
    mission: 'Lorem ipsum dolor sit, amet consectetur adipisicing elit. At delectus numquam id voluptatibus amet. Fugiat, praesentium id provident',
  ...
  return (
    <section className='projects' >
       <div className="title" >
        This is my Projects
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. At delectus numquam id voluptatibus amet. Fugiat, praesentium id provident consequatur odit sit laudantium reprehenderit illum totam, eaque sequi corrupti labore tempore!</p>
       </div>
       <div className="des" >
